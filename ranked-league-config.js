export const CURRENT_RANKED_LEAGUE_SEASON = "Season_12";
...
export const SHOTGUN_PRO_LEAGUE_DEFAULT_STAGE = 3;
export const SHOTGUN_PRO_LEAGUE_MAX_SEASON_TO_CHECK = 7;

export const SUPER_LEAGUE_SEASON = "Season 6";
