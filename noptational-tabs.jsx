    ...
    <div className="format-content">
      ...
      <section className="format-section">
        ...
        <div className="format-rule-list">
          ...
          <div className="format-rule-item">
            <h4 className="format-rule-label">Required Scoring</h4>
      ...
      <section className="format-section">
        ...
        <div className="format-rule-list">
          <div className="format-rule-item">
            <h4 className="format-rule-label">Completion</h4>
          ...
          <div className="format-rule-item">
            <h4 className="format-rule-label">Authentication</h4>
          ...
          <div className="format-rule-item">
            <h4 className="format-rule-label">Disconnects</h4>
